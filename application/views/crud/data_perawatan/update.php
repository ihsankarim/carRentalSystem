      ...
      <div class="main-content">
        <section class="section">
          ...
          <?php
            $hidden = ['idedit'=>$prwedit->id];
          ?>
          <?php echo form_open('admin/data_perawatan/save','', $hidden);?>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tanggal" name="tanggal" value="<?=$prwedit->tanggal?>" placeholder="yy-mm-dd" type="date" class="form-control" required="riquired" >
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="biaya" name="biaya" value="<?=$prwedit->biaya?>" placeholder="Rp......" type="text" class="form-control" required="riquired" >
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="text" name="km_mobil" value="<?=$prwedit->km_mobil?>" placeholder="KM" type="km_mobil" class="form-control" required="riquired" >
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="deskripsi" name="deskripsi" value="<?=$prwedit->deskripsi?>" type="text" class="form-control" required="riquired" >
      </div>
    </div>
  </div>
  <div class="form-group row">
